...
/**
 * Compares 2 TermFreq elements
 **/
public class TermFreqComparator implements Comparator<TermFreq>
{
    public int compare(TermFreq termFreq, TermFreq termFreq1)
    {
